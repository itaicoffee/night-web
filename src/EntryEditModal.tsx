        ...
        <tbody>
          {props.venueDecks &&
            props.venueDecks.map(({ deck, isAdded }, index) => (
              ...
              >
                <td className="py-4 px-6 flex justify-start">{deck.name}</td>
                <td className="py-4 px-6">{deck.venueNames.join(", ")}</td>
  ...
  return (
    ...
    >
      <div className="m-auto relative w-full max-w-2xl h-full md:h-auto">
        ...
        <form
          action="#"
          className="relative bg-white sm:rounded-lg shadow dark:bg-gray-700"
        >
          {/* Modal header */}
            ...
            <div className="grid grid-cols-6 gap-6">
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <input
                  ...
                  placeholder={props.entry.day}
                  required
                  value={mutatingEntry.day}
                  onChange={(e) =>
                    setMutatingEntry({ ...mutatingEntry, day: e.target.value })
                  }
                />
              </div>
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setMutatingEntry({
                      ...mutatingEntry,
                      numSeats: parseInt(e.target.value),
                    })
                  }
                />
              </div>
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setMutatingEntry({
                      ...mutatingEntry,
                      venueNames: e.target.value.split(", "),
                    })
                  }
                />
              </div>
              ...
              <RedButton
                ...
                onClick={() => {
                  props.onDeleteButtonClick &&
                    props.onDeleteButtonClick(mutatingEntry);
                }}
              />
            )}
          </div>
